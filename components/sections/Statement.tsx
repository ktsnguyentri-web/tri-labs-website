...
export function Statement() {
  return (
    <section className="bg-white pt-24 pb-12 w-full mx-auto relative scroll-mt-[60px]" id="statement">
        ...
        <div className="col-span-1 pt-4">
          <Reveal>
            <div className="flex flex-col gap-2">
              ...
              <div className="mt-8">
                <Button asChild variant="outline" className="h-9 text-[10px] tracking-[0.2em] border-black/10 hover:bg-black hover:text-white transition-all duration-300">
