    ...
    >
      <div className="flex flex-col md:flex-row gap-16 md:gap-24 items-center w-full max-w-[1440px] mx-auto">
        ...
        <div className="w-full md:w-1/2 flex justify-center md:justify-end">
          <div className="w-full max-w-[500px] aspect-[4/5] rounded-[12px] overflow-hidden bg-secondary relative">
            <Image
              ...
              fill
              className="object-cover rounded-[12px] transition-transform duration-700 hover:scale-105"
