            ...
            <div className="flex flex-wrap gap-x-8 gap-y-4">
              {[
                ...
                <a 
                  key={link.label} 
                  href={link.href} 
                  className="text-[12px] font-sans text-white/40 hover:text-white no-underline hover:underline decoration-white/20 hover:decoration-white underline-offset-4 transition-all duration-300"
                >
                  {link.label}
                </a>
              ))}
