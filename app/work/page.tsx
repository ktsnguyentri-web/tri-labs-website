...
export default function WorkPage() {
  ...
  const mockWorks: WorkItem[] = [
    ...
    { id: 9, title: "Parametric Furniture", category: "Design", year: "2020", span: "md:col-span-1 md:row-span-1", img: "https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&w=800&q=80" },
  ];
